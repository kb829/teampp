function manageVerRe(){
    location.href="/manageVerRe";
}
function fileupRe(){
    location.href="/fileupRe";
}
function voteRe(){
    location.href="/voteRe";
}
function scheduleManageRe(){
    location.href="/scheduleManageRe";
}
...
function toSubmitWork(){
    window.open("popup_work", "new_Project", 'width=500, height=450, resizable=no, scrollbars= 0, toolbar=0, menubar=no');
}
